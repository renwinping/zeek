...
class ConnectionTimer final : public zeek::Timer {
public:
	ConnectionTimer(Connection* arg_conn, timer_func arg_timer,
	                double arg_t, bool arg_do_expire, zeek::TimerType arg_type)
		: zeek::Timer(arg_t, arg_type)
