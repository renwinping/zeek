...
constexpr auto plrUnknown [[deprecated("Remove in v4.1. Use zeek::detail::plrUnknown.")]] = zeek::detail::plrUnknown;
constexpr auto plrFileAndLine [[deprecated("Remove in v4.1. Use zeek::detail::plrFileAndLine.")]] = zeek::detail::plrFileAndLine;
constexpr auto plrFunction [[deprecated("Remove in v4.1. Use zeek::detail::plrFunction.")]] = zeek::detail::plrFunction;
