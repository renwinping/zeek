...
rule_attr:
	...
	|	TOK_IP_PROTO TOK_COMP TOK_PROT
			...
			if ( proto )
				{
				zeek::detail::maskedvalue_list* vallist = new zeek::detail::maskedvalue_list;
				zeek::detail::MaskedValue* val = new zeek::detail::MaskedValue();
...
ranged_value:
		TOK_INT '-' TOK_INT
			...
			for ( int val = $1; val <= $3; val++ )
				{
				zeek::detail::MaskedValue* masked = new zeek::detail::MaskedValue();
				masked->val = val;
